  ...
  <body>
    ...
    <div class="container item table-striped">
      ...
      <div class="mt-4 mb-4" id="form-search">
        ...
        <?php echo Sanskrit_Common::adjective_gender_selection_button(false); ?>
        <?php echo Sanskrit_Common::adjective_grade_selection_button(false); ?>
  ...
  <footer class="">
    ...
    <script>
      ...
      function setEvents(){
          ...
          // 語形変化を検索
          Word_Change_Search.search_adjective_declension("sanskrit");
	      });
