class Input_Botton {
    ...
    {
      // テキストボックスの値を取得
      var text_sentence = $(inputId).val();
      // 入力欄に入れる
      $(inputId).val(Input_Botton.strIns(text_sentence, selIdx, str));
    }
...
class Language_Practice{
    ...
    static answer_the_question_lat_verb(){
        ...
        if(person == json_question_data['person'] &&
           ...
           tense == json_question_data['tense'] &&
    ...
    // 答え合わせ(形容詞)
    static answer_the_question_adjective(){
        // 入力情報を受け取る。
